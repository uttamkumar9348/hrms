...
class SalaryGroupService
{
    ...
    {
        $salaryGroupDetail = $this->salaryGroupRepo->findSalaryGroupDetailById($id,$select,$with);
        if(!$salaryGroupDetail){
            throw new \Exception('Salary Group Detail Not Found',404);
        }
        return $salaryGroupDetail;
    }
