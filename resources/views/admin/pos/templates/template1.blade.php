                            ...
                            <table class="no-space" style="width: 45%;margin-left: auto;">
                                <tbody>
                                    <tr>
                                        <td>{{ __('Number') }}:</td>
                                        <td class="text-right">
                                            {{ \App\Models\Utility::posNumberFormat($settings, $pos->pos_id) }}</td>
                                    </tr>

                                    <tr>
                                        <td>{{ __('Issue Date') }}:</td>
                                        <td class="text-right">
                                            {{ \App\Models\Utility::dateFormat($settings, $pos->issue_date) }}</td>
                                    </tr>
                    ...
                    @if (isset($pos->itemData) && count($pos->itemData) > 0)
                        @foreach ($pos->itemData as $key => $item)
                            <tr>
                                ...
                                <td>{{ \App\Models\Utility::priceFormat($settings, $item->price * $item->quantity + $totalTaxPrice) }}
                                </td>
                            ...
                            <table class="total-table">
                                ...
                                <tr>
                                    ...
                                    @if (!empty($posPayment->discount))
                                        <td>{{ \App\Models\Utility::priceFormat($settings, $posPayment->discount) }}
                                        </td>
                                    @else
                                        <td>-</td>
                                    @endif
                                ...
                                <tr>
                                    <td>{{ __('Total') }}:</td>
                                    @if (!empty($posPayment->discount))
                                        <td>{{ \App\Models\Utility::priceFormat($settings, $posPayment->amount - $posPayment->discount) }}
                                        </td>
                                    @else
                                        <td>{{ \App\Models\Utility::priceFormat($settings, $posPayment->amount) }}</td>
                                    @endif
