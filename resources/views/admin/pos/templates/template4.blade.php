            ...
            <tr>
                ...
                <td>
                    ...
                    <table class="no-space">
                        ...
                        <tr>
                            <td>{{__('Number')}}:</td>
                            <td class="text-right">{{\App\Models\Utility::posNumberFormat($settings,$pos->pos_id)}}</td>
                        </tr>

                        <tr>
                            <td>{{__('Issue Date')}}:</td>
                            <td class="text-right">{{\App\Models\Utility::dateFormat($settings,$pos->issue_date)}}</td>
                        </tr>
            ...
            @if(isset($pos->itemData) && count($pos->itemData) > 0)
                @foreach($pos->itemData as $key => $item)
                    <tr>
                        ...
                        <td>{{\App\Models\Utility::priceFormat($settings,$totalTaxPrice)}}</td>
                        <td>{{\App\Models\Utility::priceFormat($settings,($item->price*$item->quantity) +$totalTaxPrice)}}</td>
            ...
            <tfoot >
                ...
                <td colspan="2" class="sub-total">
                    <table class="total-table">
                        <tr>
                            <td>{{__('Subtotal')}}:</td>
                            <td>{{\App\Models\Utility::priceFormat($settings,$posPayment->amount)}}</td>
                        </tr>

                        <tr>
                            <td>{{__('Discount')}}:</td>
                            @if(!empty($posPayment->discount))
                                <td>{{\App\Models\Utility::priceFormat($settings,$posPayment->discount)}}</td>
                            @else
                                <td>-</td>
                            @endif
                        </tr>
                        ...
                        <tr>
                            <td>{{__('Total')}}:</td>
                            @if(!empty($posPayment->discount))
                                <td>{{\App\Models\Utility::priceFormat($settings,$posPayment->amount - $posPayment->discount)}}</td>
                            @else
                                <td>{{\App\Models\Utility::priceFormat($settings,$posPayment->amount )}}</td>
