    ...
    <div class="breadcrumb-button float-md-end d-md-flex align-items-center">
        @can('edit_tada')
            <a href="{{route('admin.tadas.edit',$tadaDetail->id)}}" >
                <button class="btn btn-sm btn-secondary d-md-flex align-items-center me-2"><i class="link-icon me-1" data-feather="edit"></i>Tada Edit</button>
            </a>
        @endcan

        @can('create_attachment')
            <a href="{{route('admin.tadas.attachment.create',$tadaDetail->id)}}" >
                <button class="btn btn-sm btn-secondary d-md-flex align-items-center me-2"><i class="link-icon me-1" data-feather="clipboard"></i>Upload Attachment</button>
            </a>
        @endcan

        @can('edit_tada')
            <button class="btn btn-sm btn-secondary d-md-flex align-items-center me-2"
                    id="updateStatus"
        ...
        @endcan
            ...
            <a href="{{route('admin.tadas.index')}}" >
                <button class="btn btn-sm btn-primary d-md-flex align-items-center" ><i class="link-icon" data-feather="arrow-left"></i> Back</button>
            </a>
    </div>
@endsection
