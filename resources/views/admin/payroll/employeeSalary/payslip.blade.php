                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 mb-4">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td><strong>Total Earning</strong> <span class="float-end"><strong>{{ $totalEarning}}</strong></span></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 mb-4">
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <strong>Total Deductions</strong> <span class="float-end"><strong>{{ $totalDeduction }}</strong></span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            @if($payrollData['payslipData']->include_tada ==1)
                                <div class="col-lg-6 col-md-6 border-top mt-4 pt-4">
                                    <div class="row align-items-center">
                                        <div class="col-lg-9">
                                            <small style="color:#e82e5f;">Earning*</small><br><label class="mb-0 fw-bold">TADA</label>
                                        </div>
                                        <div class="col-lg-3">
                            ...
                            <div class="col-lg-12 border-top mt-4 pt-4">
                                <h4 class="mb-1">Net Salary : {{ $currency.' '. $payrollData['payslipData']->net_salary }}</h4>
