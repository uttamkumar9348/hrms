                            ...
                            <table class="no-space" style="width: 45%;margin-left: auto;">
                                <tbody>
                                    <tr>
                                        <td>{{ __('Number') }}:</td>
                                        <td class="text-right">
                                            {{ \App\Models\Utility::purchaseNumberFormat($settings, $purchase->purchase_id) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>{{ __('Purchase Date') }}:</td>
                                        <td class="text-right">
                                            {{ \App\Models\Utility::dateFormat($settings, $purchase->purchase_date) }}
                                        </td>
                                    </tr>
                                        ...
                                        <td colspan="2">
                                            <div class="view-qrcode">
                                                {!! DNS2D::getBarcodeHTML(
                                                    route('admin.purchase.link.copy', \Crypt::encrypt($purchase->purchase_id)),
                                                    'QRCODE',
                                                    2,
                                                    2,
                                                ) !!}
                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                @if ($purchase->getTotalDiscount())
                                    <tr>
                                        <td>{{ __('Discount') }}:</td>
                                        <td>{{ \App\Models\Utility::priceFormat($settings, $purchase->getTotalDiscount()) }}
                                        </td>
                                    </tr>
                                @endif
                                ...
                                <tr>
                                    <td>{{ __('Total') }}:</td>
                                    <td>{{ \App\Models\Utility::priceFormat($settings, $purchase->getSubTotal() - $purchase->getTotalDiscount() + $purchase->getTotalTax()) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>{{ __('Paid') }}:</td>
                                    <td>{{ \App\Models\Utility::priceFormat($settings, $purchase->getTotal() - $purchase->getDue()) }}
                                    </td>
                                </tr>
