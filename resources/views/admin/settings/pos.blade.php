                                ...
                                <div class="col-md-3">
                                    <div class="card-body">
                                        ...
                                        <form id="setting-form" method="post"
                                            action="{{ route('admin.purchase.template.setting') }}"
                                ...
                                <div class="col-md-9">
                                    @if (isset($settings['purchase_template']) && isset($settings['purchase_color']))
                                        <iframe id="purchase_frame" class="w-100 h-100" frameborder="0"
                                            src="{{ route('admin.purchase.preview', [$settings['purchase_template'], $settings['purchase_color']]) }}"></iframe>
                                    @else
                                        <iframe id="purchase_frame" class="w-100 h-100" frameborder="0"
                                            src="{{ route('admin.purchase.preview', ['template1', 'fffff']) }}"></iframe>
                                    @endif
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row company-setting">
                                <div class="col-md-3">
                                    <div class="card-body">
                                        <h5></h5>
                                        <form id="setting-form" method="post"
                                            action="{{ route('admin.pos.template.setting') }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    @if (isset($settings['pos_template']) && isset($settings['pos_color']))
                                        <iframe id="pos_frame" class="w-100 h-100" frameborder="0"
                                            src="{{ route('admin.pos.preview', [$settings['pos_template'], $settings['pos_color']]) }}"></iframe>
                                    @else
                                        <iframe id="pos_frame" class="w-100 h-100" frameborder="0"
                                            src="{{ route('admin.pos.preview', ['template1', 'fffff']) }}"></iframe>
                                    @endif
                                </div>
                            </div>
                        </div>
