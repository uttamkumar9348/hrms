...
//                      request()->routeIs('admin.payment-currency.*') ||
            ...
            <li class="nav-item">
                <a href="{{route('admin.advance-salaries.index')}}"
                   ...
                   class="nav-link  {{request()->routeIs('admin.advance-salaries.*') ? 'active':''}}">Advance Salary</a>
            </li>

            <li class="nav-item">
                <a href="{{route('admin.employee-salaries.index')}}"
                   data-href="{{route('admin.employee-salaries.index')}}"
                   class="nav-link  {{request()->routeIs('admin.employee-salaries.*') ? 'active':''}}">Employee Salary</a>
            </li>
