    ...
    <div class="breadcrumb-button float-md-end d-md-flex align-items-center">
        ...
        @can('edit_task')
            <a href="{{route('admin.tasks.edit',$taskDetail->id)}}" >
                <button class="btn btn-sm btn-secondary d-md-flex align-items-center me-2"><i class="link-icon me-1" data-feather="edit"></i>Task Edit</button>
            </a>
        @endcan
        ...
        @can('upload_task_attachment')
            <a href="{{route('admin.task-attachment.create',$taskDetail->id)}}" >
                <button class="btn btn-sm btn-secondary d-md-flex align-items-center"><i class="link-icon me-1" data-feather="clipboard"></i>Upload Attachment</button>
            </a>
        @endcan
                            ...
                            <div class="checklistForm">
                                <div class="row align-items-center justify-content-between">
                                    ...
                                    <div class="col-lg-3 col-md-6 mb-4">
                                        <button class="btn btn-default btn-secondary float-md-end" id="createChecklist">Create Checklist</button>
                                    </div>
                                </div>
                                <div class="formChecklist d-none">
                                    <form id="taskAdd" class="forms-sample " action="{{route('admin.task-checklists.store')}}"  method="POST">
                                        ...
                                        <button type="submit" class="btn btn-success mb-4" id="checklistSubmit"> Submit </button>
                                    </form>
                                </div>
                            </div>
                        @endcan
