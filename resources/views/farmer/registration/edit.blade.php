...
<li class="breadcrumb-item"><a href="{{route('farmer.farming_registration.index')}}">{{__('Farmer Registration')}}</a></li>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control select" name="center_id" id="center_id" placeholder="Select Center" required>
                            ...
                            <option {{$farming->center_id == $center->id ? 'selected' : '' }} value="{{ $center->id }}">{{ $center->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="farmer_id_2" class="form-control" value="{{ $farming->farmer_id_2 }}">
                </div>
                <div class="form-group col-md-6">
                    {{ Form::label('farmer category', __('Farmer Category'),['class'=>'form-label']) }}
                    <select class="form-control select" name="farmer_category" id="farmer_category" placeholder="Select Qualification" required>
                        <option value="">{{__('Select Category')}}</option>
                        <option {{$farming->farmer_category == 'Option 1' ? 'selected' : ''}} value="Option 1">option 1</option>
                        <option {{$farming->farmer_category == 'Option 2' ? 'selected' : ''}} value="Option 2">option 2</option>
                        <option {{$farming->farmer_category == 'Option 3' ? 'selected' : ''}} value="Option 3">option 3</option>
                    </select>
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6 irregation_fields" @if(!$farming->is_irregation) style="display:none;" @endif>
                ...
                <div class="form-group col-md-6 bank_detail_fields" @if($farming->non_loan_type == 'Co-Operative' || $farming->non_loan_type == null) style="display:none;" @endif>
                    {{ Form::label('account_number', __('Account Number'),['class'=>'form-label']) }}
                    {{ Form::text('account_number', $farming->account_number, array('class' => 'form-control')) }}
                </div>
                <div class="col-md-6 bank_detail_fields" @if($farming->non_loan_type == 'Co-Operative' || $farming->non_loan_type == null) style="display:none;" @endif>
                    <div class="form-group">
                ...
                <div class="form-group col-md-6 coperative_fields" @if($farming->non_loan_type == 'Bank' || $farming->non_loan_type == null) style="display:none;" @endif>
