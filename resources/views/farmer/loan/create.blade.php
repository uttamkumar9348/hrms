...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{route('farmer.loan.index')}}">{{__('Farmer Loan')}}</a></li>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            {{ Form::text('registration_number',  '', array('id'=>'registration_number','class' => 'form-control','required'=>'required','readonly')) }}
                        </div>
                        <div class="form-group col-md-6">
                            {{ Form::label('agreement_number', __('G_Code No.'),['class'=>'form-label']) }}
                            {{ Form::text('agreement_number',  '', array('id'=>'agreement_number','class' => 'form-control','required'=>'required','readonly')) }}
                        </div>
                        <div class="form-group col-md-6">
