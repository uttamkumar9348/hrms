...
@section('main-content')
    ...
    <div class="row">
        {{ Form::model($loan, ['route' => ['farmer.loan.update', $loan->id], 'method' => 'PUT', 'class' => 'w-100']) }}
        <div class="col-12">
                ...
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select" name="loan_type_id" id="loan_type_id"
                                    ...
                                    @foreach ($types as $type)
                                        <option {{ $type->id == $loan->loan_category_id ? 'selected' : '' }}
                        ...
                        <div class="form-group col-md-6">
                            ...
                            {{ Form::text('price_kg', $loan->price_kg, ['class' => 'form-control', 'id' => 'price_kg', 'required' => 'required', 'readonly' => true, 'placeholder' => 'Price Kg']) }}
                        </div>
                        <div class="form-group col-md-6">
                            {{ Form::label('quantity', __('Quantity'), ['class' => 'form-label']) }}
                            {{ Form::number('quantity', $loan->quantity, ['class' => 'form-control', 'min' => '1', 'required' => 'required', 'id' => 'quantity']) }}
                            <span style="color:red;" id="max_text"></span>
                        </div>
                        <div class="form-group col-md-6">
                            {{ Form::label('total_amount', __('Total Amount'), ['class' => 'form-label']) }}
                            {{ Form::number('total_amount', $loan->total_amount, ['class' => 'form-control', 'required' => 'required', 'readonly' => true, 'placeholder' => 'Total Amount', 'id' => 'total_amount']) }}
                        </div>
                    </div>
                </div>
            </div>
