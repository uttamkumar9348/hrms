            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        {{ Form::text('receipt_no',$payment->receipt_no, array('class' => 'form-control','required'=>'required')) }}
                    </div>
                    <div class="form-group col-md-6">
                        {{ Form::label('agreement_number', __('G_Code No.'),['class'=>'form-label']) }}
                        {{ Form::text('agreement_number',  $payment->agreement_number , array('class' => 'form-control','required'=>'required','readonly')) }}
                    </div>
                    <div class="form-group col-md-6">
