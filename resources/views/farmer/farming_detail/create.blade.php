...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{route('farmer.farming_detail.index')}}">{{__('Farmer Detail')}}</a></li>
    <li class="breadcrumb-item">{{__('Farmer Detail Create')}}</li>
@endsection
@push('script-page')
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            {{ Form::text('plot_number', $plot_number, array('class' => 'form-control','required'=>'required','readonly')) }}
                        </div>
                        <!-- <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            {{ Form::label('tentative_harvest_quantity', __('Tentative Harvest Quantity (In Ton)'),['class'=>'form-label']) }}
                        ...
                        <div class="form-group col-md-6">
                            {{ Form::label('type', __('Harvest Type'),['class'=>'form-label']) }}
